...
export default function EventCardSmall(props: IEventCart) {
  const {imageUrls, title, startDate, endDate} = props
      ...
      <View style={[eventCardSmallStyle.infoWrapper]}>
        ...
        <View style={[eventCardSmallStyle.dateContainer]}>
          ...
          <View style={[eventCardSmallStyle.dateWrapper]}>
            ...
            <Text style={[eventCardSmallStyle.mainText]}>{dayjs(startDate).format('ha')} - {dayjs(endDate).format('ha')}</Text>
          </View>
        </View>
