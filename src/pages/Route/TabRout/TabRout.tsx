...
export default function TabRoute() {
  ...
  return (
    <SafeAreaView
      style={[styles.safeAreaContainer, { backgroundColor: accent_5 }]}
    >
            ...
            return {
              ...
              tabBarIcon: ({ focused }) => {
                ...
                if (route.name === routes.map.key) {
                  ...
                  iconComponent = (
                    <Feather name="settings" size={24} color={focusedIcon} />
                  );
                } else if (route.name === routes.today.key) {
                  iconComponent = (
                    <AntDesign name="calendar" size={24} color={focusedIcon} />
                  );
                }
