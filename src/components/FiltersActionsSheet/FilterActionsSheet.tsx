...
import {
  ...
  IColorScheme,
  IDisable,
} from "../ButtomSheetFilters/ButtomSheetFilters";
import {
  setActionFilter,
...
interface IFilterActionsSheetProps {
  ...
  setDisabledActionButtons: React.Dispatch<React.SetStateAction<IDisable>>;
}

export const FilterActionsSheet = React.memo(
  (props: IFilterActionsSheetProps) => {
    const { colorSchemeFilter, setDisabledActionButtons } = props;
